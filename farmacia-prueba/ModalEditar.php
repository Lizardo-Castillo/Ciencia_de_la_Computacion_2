...
<!--ventana para Update--->
<div class="modal fade" id="editChildresn<?php echo $dataCliente['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="ttext  <div class="modal-dialog">
        ...
        <input type="hidden" name="id" value="<?php echo $dataCliente['id']; ?>">
            ...
            <div class="modal-body" id="cont_modal">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="producto" class="form-control" value="<?php echo $dataCliente['producto']; ?>" required="true">
                </div>
                <div class="form-group">
                  <label for="recipient-name" class="col-form-label">Lugar:</label>
                  <input type="text" name="lugar" class="form-control" value="<?php echo $dataCliente['lugar']; ?>" required="true">
                </div>
